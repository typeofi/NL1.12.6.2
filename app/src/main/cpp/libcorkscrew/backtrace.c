...
ssize_t unwind_backtrace_signal(siginfo_t *siginfo, void *sigcontext, backtrace_frame_t *backtrace,
                                size_t ignore_depth, size_t max_depth) {
    map_info_t *milist = acquire_my_map_info_list();
    return unwind_backtrace_signal_arch(siginfo, sigcontext, milist, backtrace, ignore_depth,
                                        max_depth);
}
...
void
format_backtrace_line(unsigned frameNumber, const backtrace_frame_t *frame __attribute__((unused)),
