...
Java_net_zhuoweizhang_mcpelauncher_ScriptManager_nativePlayerGetEnchantments
        (JNIEnv *, jclass, jint);
...
Java_net_zhuoweizhang_mcpelauncher_ScriptManager_nativePlayerGetItemCustomName
        (JNIEnv *, jclass, jint);
 ...
 */
JNIEXPORT void JNICALL
Java_net_zhuoweizhang_mcpelauncher_ScriptManager_nativePlayerSetItemCustomName
        (JNIEnv *, jclass, jint, jstring);
