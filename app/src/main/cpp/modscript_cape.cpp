...
static int
(*bl_HumanoidMobRenderer_prepareArmor_real)(HumanoidMobRenderer *self, Entity *mob, int armorPart,
                                            float partialTicks);
...
// armour
int bl_HumanoidMobRenderer_prepareArmor_hook(HumanoidMobRenderer *self, Entity *mob, int armorPart,
                                             float partialTicks) {
    ...
    HumanoidModel *armorModel =
            armorItem->armorType == 2 ? self->modelArmorChestplate : self->modelArmor;
...
void bl_cape_init(void *mcpelibinfo) {
    void *prepareArmor = dlsym(mcpelibinfo,
                               "_ZN19HumanoidMobRenderer12prepareArmorER3Mob9ArmorSlotf");
