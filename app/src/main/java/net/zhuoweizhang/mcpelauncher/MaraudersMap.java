...
public final class MaraudersMap {
    ...
    public static boolean initPatching(Context context, long minecraftLibLength) throws Exception {
        ...
        boolean useOldCode = Utils.Default().getBoolean("zz_legacy_live_patch", false) ||
        ...
        Log.i("BlockLauncher", "Live patching is running in " + (useOldCode ? "legacy" : "normal") + " mode");
        ...
        while (scan.hasNextLine()) {
            ...
            if (parts[parts.length - 1].contains("libminecraftpe.so")) {
