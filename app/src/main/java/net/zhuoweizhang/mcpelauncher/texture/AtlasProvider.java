...
public class AtlasProvider implements TexturePack {
    ...
    private final String mipPrefix;
    ...
    public InputStream getInputStream(String fileName) throws IOException {
        ...
        if (fileName.equals(metaName)) {
            return new ByteArrayInputStream(metaObj.data.toString().getBytes(StandardCharsets.UTF_8));
    ...
    private void loadAtlas(MainActivity activity) throws Exception {
        ...
        JSONArray metaArr = new JSONArray(bos.toString(String.valueOf(StandardCharsets.UTF_8)));
    ...
    public void dumpAtlas() throws IOException {
        ...
        os3.write(metaObj.data.toString().getBytes(StandardCharsets.UTF_8));
        os3.close();
    }
