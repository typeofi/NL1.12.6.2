...
public class ManageScriptsActivity extends ListActivity implements View.OnClickListener, OnRefreshContentList {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        importButton = findViewById(R.id.manage_patches_import_button);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            ...
            master = menu.findItem(R.id.ab_switch_container)
    ...
    public void onPrepareDialog(int dialogId, Dialog dialog) {
        switch (dialogId) {
            ...
            case DIALOG_IMPORT_FROM_CLIPBOARD_CODE:
                ...
                ClipboardManager cmgr = (ClipboardManager) this.getSystemService(Context.CLIPBOARD_SERVICE);
    ...
    private String getPatchInfo(ContentListItem patchItem) throws IOException {
        String builder = this.getResources().getString(R.string.manage_patches_path) +
                ": " +
                patchItem.file.getAbsolutePath() +
                '\n';
     ...
     */
    private static final char[] cfgyMappings = new char[]{'f', 't', 'a', 'm', 'b', 'q', 'g', 'r', 'z', 'o'};
    ...
    private boolean versionIsSupported() {
        try {
            return getPackageManager().getPackageInfo("net.zhuoweizhang.mcpelauncher.pro"
                    , 0).versionCode == MinecraftConstants.MINECRAFT_VERSION_CODE;
    ...
    private class ImportScriptFromUrlTask extends ImportScriptTask<String> {
        protected File doInBackground(String... ids) {
            ...
            try {
                //Hurl the file to a byte array
                url = new URL(ids[0]);
                Log.i("BlockLauncher", String.valueOf(url));
    ...
    public void onRefreshComplete(final List<ContentListItem> items) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                List<String> allPaths = new ArrayList<>(patches.size());
