...
public class ManageSkinsActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.manage_skins_select).setOnClickListener(new OnClickListener() {
            @Override
        ...
        findViewById(R.id.manage_skins_players)
                        ...
                        b.setSingleChoiceItems(items, getCurrentMode(),
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        SharedPreferences.Editor prefs = Utils.Default().edit();
                                        switch (which) {
                                            case 1:
    ...
    public void saveHistory() {
        if (isEnabled()) {
            ...
            out = Utils.join(res, ";");
            SharedPreferences.Editor sh = Utils.MC().edit();
    ...
    protected boolean isEnabled() {
        SharedPreferences sh = Utils.Default();
        return sh.getBoolean("zz_skin_enable", false);
    }

    public static void setSkin(File f, ManageSkinsActivity activity) {
        SharedPreferences.Editor p1 = Utils.Default().edit();
        SharedPreferences.Editor p2 = Utils.MC().edit();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            ...
            master = menu.findItem(R.id.ab_switch_container).getActionView()
