...
public class NerdyStuffActivity extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle icicle) {
        ...
        dumpLibMinecraftPeButton = findViewById(R.id.dump_libminecraftpe_button);
        ...
        setSkinButton = findViewById(R.id.set_skin_button);
        setSkinButton.setOnClickListener(this);
        chefSpecialButton = findViewById(R.id.chef_special);
        chefSpecialButton.setOnClickListener(this);
        if (BuildConfig.DEBUG)
            chefSpecialButton.setVisibility(View.VISIBLE);
        dumpModPEMethodsButton = findViewById(R.id.dump_modpe_methods);
    ...
    public void dumpModPEMethods() {
        ...
        try {
            FileWriter w = new FileWriter(new File(Environment.getExternalStorageDirectory(),
                    "/modpescript_dump.js").getAbsolutePath());
            w.write(allMethods);
            w.close();
        } catch (Exception e) {
            e.printStackTrace();
        ...
        new AlertDialog.Builder(this).setTitle("保存到sd：modpescript_dump.js").setMessage(allMethods)
